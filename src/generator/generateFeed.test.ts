    ...
    const feedData: Feed = {
      items: [
        ...
        },
        {
          ...
          description: 'Description with author',
          link: 'https://krajvy.github.io/dummy/title-with-author',
          author: 'Al Dente',
        },
      ],
      channel: channelData,
